                                ...
                                <div class="card-body card-dashboard">
                                    <form class="form-horizontal" action="{{ url('cooker/update-profile') }}"
                                        ...
                                        <div class="row match-height">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-12">
                                            <fieldset class="form-group ">
                                            <label class="card-title success" for="inputSuccess">الجنسية</label>
                                                    <select class="select2 c-select form-control" id="nationality" name="nationality">
                                                        <option value="">اختر الجنسية</option>
                                                        @foreach($nationalities as $nationality)
                                                        <option value="{{ $nationality->id }}" @if($cookerDetails->nationality_id==$nationality->id) selected
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-12">
                                                <fieldset class="form-group">
                                                    <label class="card-title success" for="inputSuccess">رقم محفظة كاش</label>
                                                    <input type="text" class="form-control border-success info" id="helpInput9"
                                                        placeholder=" رقم محفظة كاش" name="phoneCash"
                                                        id="phoneCash"
                                                        minlength="11" maxlength="12"
                                                        value="{{ $cookerDetails->phoneCash }}">
                                                    @error("phoneCash")
                                                    <p class="badge-default badge-danger block-tag text-center">
                                                        <small class="block-area white">{{$message}}</small>
                                                    </p>
