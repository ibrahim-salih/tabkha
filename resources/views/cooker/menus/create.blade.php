                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:;">اضافة صنف جديد</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ route('cooker.menus.store') }}" method="post" novalidate enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="food" id="food" class="select2 form-control border-success info">
                                                        <option value="">اختر الطبخة</option>
                                                    </select>
                                                    @error("food")
                                                    <p class="badge-default badge-danger block-tag text-center">
                                                        <small class="block-area white">{{$message}}</small>
