              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  ...
                  @if(Session::has('success_message'))
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ route('cooker.login.post') }}" method="POST" >
                    @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6 col-12 text-center text-md-right"><a href="#" class="card-link">نسيت كلمة المرور</a></div>
                      </div>
                ...
                <div class="card-footer border-0">
                  ...
                  <a href="{{ route('cooker.register') }}" class="btn btn-info btn-block btn-lg mt-3"><i class="ft-user"></i> تسجيل حساب</a>
                </div>
