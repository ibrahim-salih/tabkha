                                        ...
                                        <div class="col-xl-2 col-lg-2 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <div class="row skin skin-flat">
                                                    <fieldset>
                                                        <input type="radio" value="Male" name="gender" id="input-radio-11" @if($cooker->gender == 'Male') checked @endif>
                                                        <label for="input-radio-11" class="card-title info">ذكر</label>
                                                    </fieldset>
                                                    <fieldset>
                                                        <input type="radio" value="Female" name="gender" id="input-radio-12" @if($cooker->gender == 'Female') checked @endif>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <select class="select2 c-select form-control" id="country" name="country">
                                                        ...
                                                        <option value="{{ $country->id }}" @if($cooker->country_id==$country->id) selected
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select class="c-select form-control" id="state" name="state">
                                                    @foreach($staties as $state)
                                                        <option value="{{ $state->id }}" @if($cooker->state_id==$state->id) selected
                                                        @endif>
                                                            {{ $state->name }}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                @if($cooker->image!= null || $cooker->image!= '')
                                                    @if(File::exists(public_path($cooker->image)))
                                                        <img src="{{ url($cooker->image) }}" class="rounded-circle  height-150"
                                                             alt="{{ $cooker->username }}" title="{{ $cooker->username }}">
                                                    @else
