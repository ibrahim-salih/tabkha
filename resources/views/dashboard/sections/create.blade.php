                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:;">اضافة قسم جديد</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ route('dashboard.sections.store') }}" method="post" novalidate enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <!-- <div class="col-xl-3 col-lg-6 col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="type" id="type"
                                                        ...
                                                        <option value="news" {{old('type')=='news' ? 'selected' : ''}}>اخبارى</option>
                                                        <option value="articles" {{old('type')=='articles' ? 'selected' : ''}}>مقالات</option>
                                                    </select>
                                                    @error("type")
                                                    <p class="badge-default badge-danger block-tag text-center">
                                                        <small class="block-area white">{{$message}}</small>
