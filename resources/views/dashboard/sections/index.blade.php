                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:;">الاقسام</a>
                            </li>
                                        ...
                                        <table class="table table-striped table-bordered dom-jQuery-events">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-bottom-teal border-bottom-darken-2 border-custom-color">
                                                    ...
                                                    <td>{!! html_entity_decode ($section->name) !!}</td>
                                                    <!-- <td>{{ $section->order_is }}</td> -->
                                                    <td>
                                                        <fieldset>
                                                            <div class="float-left">
                                                                <input type="checkbox" name="toogle" value="{{ $section->id }}" data-toggle="toggle" data-onstyle="outline-info" data-offstyle="outline-warning" data-on="مفعل" data-off="غير مفعل" {{ $section->status=='1' ? 'checked' : '' }}>

                                                            </div>
                                                        </fieldset>
                                                    </td>
                                                    <td>
                                                        <a title="حذف-{{ $section->name }}" class="confirmDeleteTr btn btn-sm btn-outline-warning" href="javascript:void(0)" sec="sections" module="softDelete" moduleid="{{ $section->id }}"><i
                                                                class="la la-bitbucket-square"></i></a>
                                                        <a title="تعديل-{{ $section->name }}" href="{{ route('dashboard.sections.edit', $section->id) }}" class="btn btn-sm btn-outline-info"><i
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body text-center">
                                                <p>لا يوجد <code>.اقسام</code> حاليا</p>
