                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:;">تعديل privacys</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ url('dashboard/privacys/update') }}" method="post" novalidate enctype="multipart/form-data">
                                @csrf
                                <div class="card-content">
                                    <div class="card-body">
                                    <input type="hidden" name="id" value="{{ $webPrivacy->id }}">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border-success info" name="name"
                                                        id="name"
                                                    @if(empty($webPrivacy->name)) value="{{ old('name') }}"
                                                    @else
                                                    value="{{ $webPrivacy->name }}"
                                                    @endif
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" cols="30" rows="15" class="ckeditor">@if(empty($webPrivacy->description)) {{ old('description') }}
                                                    @else
                                                    {{ $webPrivacy->description }}
                                                    @endif</textarea>
                                                    @error("description")
                                                    <p class="badge-default badge-danger block-tag text-center">
                                                        <small class="block-area white">{{$message}}</small>
