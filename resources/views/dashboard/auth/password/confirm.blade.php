                  ...
                  <div class="card-body">
                    ...
                    @csrf
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input name="code" type="text" class="form-control form-control-lg input-lg" id="user-code"
                      ...
                      <button type="submit" class="btn btn-outline-info btn-lg btn-block"><i class="ft-unlock"></i> {{ __('auth.R_P')}}</button>
                    </form>
                  </div>
                </div>
