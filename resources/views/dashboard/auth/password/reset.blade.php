                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <fieldset hidden class="form-group position-relative has-icon-left">
                        <input hidden name="email" value="{{ $email }}" type="email" class="form-control form-control-lg input-lg" id="user-email"
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input name="password" type="password" class="form-control form-control-lg input-lg" id="user-email"
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input name="password_confirmation" type="confirm" class="form-control form-control-lg input-lg" id="user-email"
                        placeholder="Your Email Address" required>
                        <div class="form-control-position">
                          <i class="ft-mail"></i>
                        </div>
