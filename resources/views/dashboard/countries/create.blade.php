                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:;">اضافة منطقة جديدة</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">بيانات المنطقة</h4>
                            ...
                            <form class="form-horizontal" action="{{ route('dashboard.countries.store') }}" method="post" novalidate enctype="multipart/form-data">
                                @csrf
