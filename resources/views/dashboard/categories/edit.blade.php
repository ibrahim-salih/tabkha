                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ url('dashboard/categories/update') }}" method="post" novalidate enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border-success info" name="name"
                                                        id="name"
                                                    @if(empty($category->name)) value="{{ old('name') }}"
                                                    @else
                                                    value="{{ $category->name }}"
                                                    @endif
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="section" id="section"
                                                        ...
                                                        <option value="{{ $section->id }}" @if(!empty($section->id) && $category->section_id==$section->id) selected
