              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="{{asset('cooker')}}/app-assets/images/slider/slider-2.png"
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              ...
              <span class="avatar avatar-online">
                ...
                @if(File::exists(public_path(Auth::guard('cooker')->user()->image)))
                <img src="{{ url(Auth::guard('cooker')->user()->image) }}" style="height:35px;" class="rounded-circle  " alt="image"><i></i>
                @else
                <img src="{{ url('dashboard/app-assets/images/portrait/small/avatar-s-19.png') }}" alt="image"><i></i>
                @endif
                @else
                <img src="{{ url('dashboard/app-assets/images/portrait/small/avatar-s-19.png') }}" alt="image"><i></i>
                @endif
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <form action="{{ route('cooker.logout')}}" method="POST">
                @csrf
                <button type="submit" class="dropdown-item" href="#"><i class="ft-power"></i> تسجيل الخروج</button>
              </form>
            </div>
          </li>
                ...
                <li class="scrollable-container media-list w-100">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('cooker')}}/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('cooker')}}/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('cooker')}}/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('cooker')}}/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
