<!DOCTYPE html>
<html class="loading" lang="en" data-textdirection="@if(Config::get('app.local') == 'ar') rtl @else ltr @endif">
<head>
  ...
  <title>لوحة الادارة | @yield('title')</title>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('dashboard')}}/app-assets/css-rtl/wizard.css">
  <!-- END Custom CSS-->
  @livewireStyles
</head>
...
data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              ...
              <h3 class="brand-text">لوحة الادارة</h3>
            </a>
          </li>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">حقوق النسخ 2025 <a class="text-bold-800 grey darken-2" href="https://minysoft-eg.com"
        target="_blank">مينى سوفت </a>, كل الحقوق محفوظة </span>
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">انشئ من الصفر <i class="ft-heart pink"></i></span>
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
  ...
  <script src="{{asset('dashboard')}}/app-assets/vendors/js/pickers/dateTime/moment-with-locales.min.js"
  ...
  <!-- END PAGE LEVEL JS-->
  <script src="{{ url('dashboard') }}/script/customCooker.js"></script>
  @livewireScripts
</body>
</html>