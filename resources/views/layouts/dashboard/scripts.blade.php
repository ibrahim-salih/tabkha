...
<script src="{{asset('dashboard')}}/app-assets/vendors/js/vendors.min.js" type="text/javascript"></script>
  ...
  <script src="{{asset('dashboard')}}/app-assets/vendors/js/editors/ckeditor/ckeditor.js" type="text/javascript"></script>
  ...
  <script src="{{asset('dashboard')}}/app-assets/vendors/js/forms/spinner/jquery.bootstrap-touchspin.js" type="text/javascript"></script>
  <script src="{{asset('dashboard')}}/app-assets/js/scripts/forms/checkbox-radio.js" type="text/javascript"></script>
  <script src="{{asset('dashboard')}}/app-assets/js/scripts/forms/input-groups.js" type="text/javascript"></script>
...
<script src="{{asset('dashboard')}}/app-assets/js/scripts/forms/checkbox-radio.js" type="text/javascript"></script>
  ...
  <!-- END PAGE LEVEL JS-->
  <script src="{{ url('dashboard') }}/script/custom.js"></script>