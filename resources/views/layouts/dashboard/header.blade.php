          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              ...
              <span class="avatar avatar-online">
                ...
                <img src="{{ url(Auth::guard('admin')->user()->image) }}" style="height:35px;" class="rounded-circle  " alt="image"><i></i>
                @else
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item" href="{{ route('dashboard.profile') }}"><i class="ft-user"></i>  الملف الشخصي</a>
              <a class="dropdown-item" href="{{ route('dashboard.password') }}"><i class="ft-check-square"></i> كلمة المرور</a>
